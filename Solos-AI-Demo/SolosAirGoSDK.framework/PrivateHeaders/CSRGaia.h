...
@protocol CSRGaiaInterface <NSObject>
...
/*!
 @brief Play a tone
 @param toneId ID of tone to be played
 */
...
@interface CSRGaia : NSObject <CSRGaiaInterface>
 ...
 */
- (void)connectPeripheral:(CSRPeripheral *_Nullable)peripheral;
...
// write char value response
- (void)peripheral:(CBPeripheral *_Nonnull)peripheral
...
// read battery
- (void)didReadBattery:(int)mV;
// user eq on/off
- (void)didGet:(GaiaCommandStatus)status userEQOn:(BOOL)on;
- (void)didSetUserEQOn:(GaiaCommandStatus)status;
// eq control
- (void) didGet:(GaiaCommandStatus)status EQBank:(int)bankNum;
- (void) didSetEQBank:(GaiaCommandStatus)status;
// eq parameter
- (void) didGet:(GaiaCommandStatus)status  EQParameterBank:(uint8_t)bank band:(uint8_t)band  param:(GaiaParamEQParameterType)param value:(uint16_t)value;
- (void) didSetEQParameter:(GaiaCommandStatus)status;
// device reset
- (void) didDeviceReset:(GaiaCommandStatus)status;
// data end point mode for ota update
- (void) didSet:(GaiaCommandStatus)status dataEndPointMode:(BOOL)on;
// av events/control
- (void) didSetAvControl:(GaiaCommandStatus)status;
