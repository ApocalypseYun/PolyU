...
@property (nonatomic) NSArray * _Nullable interestedServiceUUIDs;
...
- (id _Nonnull) init:(BOOL)autoConnectLastDevice;
/*!
 ...
 */
- (void)didDisconnectFromPeripheral:(CSRPeripheral *_Nonnull)peripheral;
